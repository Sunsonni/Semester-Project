...
//TODO: figure out of ?? null needed or not. Flow of application
...
$stmt = $conn->prepare("UPDATE users SET api_key =  :api_key, api_key_iv = :api_key_iv WHERE user_id = :user_id");
$stmt->execute([
